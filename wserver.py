...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://telegra.ph/file/10a8fa52782e49b99053b.jpg" type="image/jpg">
    <script
...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      <div class="brand">
        <img
          src="https://telegra.ph/file/10a8fa52782e49b99053b.jpg"
          alt="logo"
        />
        <a href="https://github.com/4r3t"> 
          <h2 class="name">dEV's mirrorbot</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/4r3t/KV"><i class="fab fa-github"></i></a>
        <a href="https://github.com/4r3t"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
async def homepage(request):
    ...
    return web.Response(text="<h1>See dEV's mirrorbot <a href='https://github.com/4r3t/KV'>@GitHub</a> By <a href='https://github.com/4r3t'>4r3t</a></h1>", content_type="text/html")
    ...
    async def middleware_handler(request):
        ...
        try:
            ...
            if response.status == 404:
                return web.Response(text="<h1>404: Page not found</h2><br><h3>dEV's mirrorbot</h3>", content_type="text/html")
            return response
